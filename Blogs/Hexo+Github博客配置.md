...
![](https://img.ethancao.cn/Hexo+Github博客配置-1.png)

### 域名解析
从云服务商处购买自定义域名并配置解析

[腾讯云解析 DNS - 控制台](https://console.cloud.tencent.com/cns)
![](https://img.ethancao.cn/Hexo+Github博客配置-9.png)
...
![](https://img.ethancao.cn/Hexo+Github博客配置.png)
...
![](https://img.ethancao.cn/Hexo+Github博客配置-5.png)
...
### 使用VSCode编辑
- 基础插件配置
![](https://img.ethancao.cn/Hexo+Github博客配置-6.png)
- 用户配置`settings.json`
```json
{
...
![](https://img.ethancao.cn/Hexo+Github博客配置-7.png)


推荐两款Obsidian插件：
![](https://img.ethancao.cn/Hexo+Github博客配置-8.png)
