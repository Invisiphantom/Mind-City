...
| sll     | Shift Left Logical            | R   | 0110011 | 001    | 0000000 | R[rd] = R[rs1] << R[rs2]             |
| srl     | Shift Right Logical           | R   | 0110011 | 101    | 0000000 | R[rd] = R[rs1] >> R[rs2]             |
| sra     | Shift Right Arith             | R   | 0110011 | 101    | 0100000 | R[rd] = R[rs1] >>> R[rs2]            |
...
| ------- | ------                        | --- | ------- | ------ | ------- | ---------                            |
| addi    | ADD Immediate                 | I   | 0010011 | 000    |         | R[rd] = R[rs1] + imm                 |
| xori    | XOR Immediate                 | I   | 0010011 | 100    |         | R[rd] = R[rs1] ^ imm                 |
| ori     | OR Immediate                  | I   | 0010011 | 110    |         | R[rd] = R[rs1] \| imm                |
| andi    | AND Immediate                 | I   | 0010011 | 111    |         | R[rd] = R[rs1] & imm                 |
| slli    | Shift Left Logical Immediate  | I   | 0010011 | 001    | 0000000 | R[rd] = R[rs1] << imm                |
| srli    | Shift Right Logical Immediate | I   | 0010011 | 101    | 0000000 | R[rd] = R[rs1] >> imm                |
| srai    | Shift Right Arith Immediate   | I   | 0010011 | 101    | 0100000 | R[rd] = R[rs1] >>> imm               |
| slti    | Set Less Than Immediate       | I   | 0010011 | 010    |         | R[rd] = (R[rs1] < imm)?1:0           |
| sltiu   | Set Less Than Immediate (U)   | I   | 0010011 | 011    |         | R[rd] = (R[rs1] < imm)?1:0           |
| ------- | ------                        | --- | ------- | ------ | ------- | ---------                            |
...
| ------- | ------                        | --- | ------- | ------ | ------- | ---------                            |
| lui     | Load Upper Immediate          | U   | 0110111 |        |         | R[rd] = imm << 12                    |
| auipc   | Add Upper Immediate to PC     | U   | 0010111 |        |         | R[rd] = PC + (imm << 12)             |
| ------- | ------                        | --- | ------- | ------ | ------- | ---------                            |
...
| csrrwi  | CSR Read Write Immediate      | I   | 1110011 | 101    |         |                                      |
| csrrsi  | CSR Read Set Immediate        | I   | 1110011 | 110    |         |                                      |
| csrrci  | CSR Read Clear Immediate      | I   | 1110011 | 111    |         |                                      |
