...
其中发生冲突的种数 $|\{r\equiv s\pmod m\}|=p/m-1\leq(p-1)/m$
...
$E[X]=\sum_{i=1}^n\sum_{j=i+1}^k1/n^2=C_n^2\cdot1/n^2=\frac{n^2-n}{2}\cdot\frac{1}{n^2}<1/2$
