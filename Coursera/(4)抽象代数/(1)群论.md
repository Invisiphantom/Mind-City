...
则$mk$要同时为m和n的最小公倍数, 即$mk=lcm(m,n)\implies k=\frac{lcm(m,n)}{m}$
...
已知**非空集合N**, 从N到自身的所有双射$f:N\leftrightarrow N$
...
已知**有限集合N**, 从N到自身的所有双射(置换)$f:N\leftrightarrow N$
...
将划分块数称为H在G中的指数, 记为$[G:H]=|G/H|=|\{aH|a\in G\}|$
