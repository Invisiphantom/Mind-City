...
1. 单位元: $e_S\in H$
2. 运算封闭: $\forall a,b\in H, a*b\in H$
...
\end{aligned}\right.$
如果任意$m_i,m_j$两两互素,即$\forall m_1\neq m_j,\gcd(m_i,m_j)=1$, 那么方程组有解
...
首先证明特解: $\forall m_1\neq m_j,\gcd(m_i,m_j)=1\iff\gcd(m_i,M_i)=1\iff\mathbb{Z_{m_i}}=\langle M_i\rangle\iff\exists t_i\in\mathbb{Z},t_iM_i\equiv1\pmod{m_i}$
...
然后证明通解: 对于任意两解$x_1,x_2$,有$\left\{\begin{aligned}
      x_1&\equiv a_i\pmod{m_i} \\
      x_2&\equiv a_i\pmod{m_i}
\end{aligned}\right.\implies x_1-x_2\equiv0\pmod{\forall m_i}\iff \forall m_i|(x_1-x_2)\implies lcm(\forall m_i)|(x_1-x_2)\iff??? M|(x_1-x_2)$
