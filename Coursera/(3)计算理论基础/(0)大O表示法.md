...
$1<\lg(\lg^*n)<\lg^*n<\lg^*(\lg n)<2^{\lg^*n}<\ln\ln n<\ln n<\lg^2 n$
$<2^{\sqrt{2\lg n}}<[\sqrt{n}=(\sqrt{2})^{\lg n}=2^{1/2\lg n}]<[n=2^{\lg n}]<[n^2=4^{\lg n}]<n^3$
$<[(\lg n)!\sim\sqrt{\lg n}(\lg n)^{\lg n}]<(3/2)^n<2^n<n\cdot2^n<e^n<n!<(n+1)!$