...
5. 转移函数: 类似网络图, 且任何状态到自身和其他状态都有箭头
...
![image.png](https://s2.loli.net/2024/03/21/p7n9HotDyWjd1ri.png =400x)

![image.png](https://s2.loli.net/2024/03/21/4ajnCrpG2tP6yVz.png =400x)
...
2. $a<b\implies a\le b-1\implies y=s_a\cdots s_{b-1}\neq\epsilon$
3. $a<b\le p+1\implies |xy|=b-1\le p$
